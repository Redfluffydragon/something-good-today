  ...
  {#each items as project (project.id)}
    <li class="relative" class:selected={selectedProject === project.id} animate:flip={{ duration: 300 }}>
      <svg width="16" height="16" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M25 32C25 34.7614 22.7614 37 20 37C17.2386 37 15 34.7614 15 32C15 29.2386 17.2386 27 20 27C22.7614 27 25 29.2386 25 32Z" fill="black" />
        <path d="M48 32C48 34.7614 45.7614 37 43 37C40.2386 37 38 34.7614 38 32C38 29.2386 40.2386 27 43 27C45.7614 27 48 29.2386 48 32Z" fill="black" />
